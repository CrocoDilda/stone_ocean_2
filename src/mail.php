...
try {
  ...
  $mail->Username   = 'Gundiai@yandex.ru'; // Логин на почте
  $mail->Password   = 'hislyedfepoziegl'; // Пароль на почте
  $mail->SMTPSecure = 'ssl';
  $mail->Port       = 465;

  $mail->setFrom('Gundiai@yandex.ru', 'Заявка с сайта'); // Адрес самой почты и имя отправителя

  // Получатель письма
  $mail->addAddress('kirillovgundyai@yandex.ru');
